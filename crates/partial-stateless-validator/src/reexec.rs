    ...
    Oracle: PostStateRootOracle + ?Sized,
{
    ...
    let mut timings = ValidationPhaseTimings {
        ...
        retention_delta_unproven: u64::from(cache_timings.retention.delta_unproven),
        retention_delta_refused: cache_timings.retention.narrowing.refused,
        retention_delta_ineligible: cache_timings.retention.narrowing.ineligible,
        retention_oracle_checks: cache_timings.retention.narrowing.oracle_checks,
        retention_oracle_us: cache_timings.retention.narrowing.oracle_us,
